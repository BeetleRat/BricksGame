...
[Serializable]
public struct AvatarBody : ISerializable
{
    ...
    public AvatarBody(int maxJointsLength)
    {
    ...
    public static AvatarBody DeepCopy(AvatarBody copyFromBody)
    {
        int maxJointsLength = copyFromBody.Length;
        AvatarBody copiedBody = new AvatarBody(maxJointsLength);
    ...
    public AvatarBody(SerializationInfo info, StreamingContext context)
    {
